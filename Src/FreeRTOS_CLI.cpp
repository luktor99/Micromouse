...
static const char * const CLI_help_prefix = "\033[1;33m"; // yellow color
static const char * const CLI_help_infix = "\033[0m:\r\n";
static const char * const CLI_help_suffix = "\r\n\r\n";
...
size_t xCommandStringLength;
	...
	if( ( pxCommand != NULL ) && ( xReturn == pdFALSE ) )
	{
		...
		was incorrect. */
		strncpy( pcWriteBuffer, "\033[1;31mIncorrect command parameter(s). Enter \"help\" to view a list of available commands.\r\n\r\n\033[0m", xWriteBufferLen );
		pxCommand = NULL;
	}
	...
	else
	{
		...
		strncpy( pcWriteBuffer, "\033[1;31mCommand not recognised. Enter 'help' to view a list of available commands.\r\n\r\n\033[0m", xWriteBufferLen );
		xReturn = pdFALSE;
	}
...
BaseType_t xReturn;
	...
	do {
		print(CLI_help_prefix);
		print(pxCommand->pxCommandLineDefinition->pcCommand);
		print(CLI_help_infix);
		print(pxCommand->pxCommandLineDefinition->pcHelpString);
		print(CLI_help_suffix);
